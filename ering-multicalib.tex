...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.99\textwidth]{1_EringFishpass_domain.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=5.5in]{2_EringFishpass_mesh.png}
